...
#SBATCH --output=/hpc2hdd/home/mzhang630/data/nature/experiments/logs/emo_narr_%j.out
...
echo "=== Emotion vs Narrative ($(date)) ==="
python3 src/emotion_vs_narrative.py \
