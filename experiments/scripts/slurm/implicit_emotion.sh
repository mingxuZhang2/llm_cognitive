...
#SBATCH --output=/hpc2hdd/home/mzhang630/data/nature/experiments/logs/imp_emo_%j.out
...
echo "=== Implicit emotion test ($(date)) ==="
python3 src/implicit_emotion_test.py \
