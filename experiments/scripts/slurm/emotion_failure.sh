...
#SBATCH --output=/hpc2hdd/home/mzhang630/data/nature/experiments/logs/emo_fail_%j.out
...
echo "=== Emotion failure analysis ($(date)) ==="
python3 src/emotion_failure_analysis.py \
