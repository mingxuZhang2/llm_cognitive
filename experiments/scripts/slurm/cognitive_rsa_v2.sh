...
#SBATCH --mem=192G
#SBATCH --time=2:00:00
#SBATCH --output=/data/user/mzhang630/logs/cog_rsa_v2_%A_%a.out
#SBATCH --error=/data/user/mzhang630/logs/cog_rsa_v2_%A_%a.err
#SBATCH --array=0-3

# v2 RSA extraction: per-stimulus, 3 pooling strategies, all layers.
