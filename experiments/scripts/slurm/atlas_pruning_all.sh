...
# Atlas-guided pruning: compare atlas vs magnitude vs random at 10-50% sparsity
...
mkdir -p ${BASE}/results/pruning /data/user/mzhang630/logs

echo "Atlas-Guided Pruning: ${MODEL_SHORT}"
...
python atlas_pruning.py \
    ...
    --output_dir "${BASE}/results/pruning" \
