...
#SBATCH --mem=128G
#SBATCH --time=2:00:00
#SBATCH --output=/data/user/mzhang630/logs/cog_rsa_%A_%a.out
#SBATCH --error=/data/user/mzhang630/logs/cog_rsa_%A_%a.err
#SBATCH --array=0-3

# RSA: extract per-condition last-token hidden state across every layer
# on the RSA stimulus set (14 cognitive conditions, ~712 stimuli total).
...
echo "============================================================"
echo "Cognitive RSA activation extraction: ${MODEL_SHORT}"
echo "============================================================"
cd "${SRC}"

python extract_rsa_activations.py \
