...
#SBATCH --output=/hpc2hdd/home/mzhang630/data/nature/experiments/logs/emo_case_%j.out
...
echo "=== Emotion response cases ($(date)) ==="
python3 src/emotion_response_cases.py \
