...
#SBATCH --output=/hpc2hdd/home/mzhang630/data/nature/experiments/logs/logit_lens_%j.out
...
echo "=== Logit lens ($(date)) ==="
python3 src/emotion_logit_lens.py --model_path "$MODEL_PATH" --model_short "Qwen2.5-7B-Instruct"
echo "=== DONE ($(date)) ==="
