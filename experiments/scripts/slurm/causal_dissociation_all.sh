...
#SBATCH --mem=128G
#SBATCH --time=4:00:00
#SBATCH --output=/data/user/mzhang630/logs/causal_%A_%a.out
#SBATCH --error=/data/user/mzhang630/logs/causal_%A_%a.err
#SBATCH --array=0-2

# Causal attribution + targeted dissociation for remaining 3 models
# (Qwen already done in job 306847)
...
echo "Causal Attribution: ${MODEL_SHORT}"
